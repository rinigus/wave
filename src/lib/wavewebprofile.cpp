...
WaveWebProfile::WaveWebProfile(QObject *parent)
    : QQuickWebEngineProfile(parent)
    , m_questionLoader(nullptr)
    , m_urlInterceptor(nullptr)
{
    connect(this, &QQuickWebEngineProfile::downloadRequested, this, &WaveWebProfile::handleDownload);
    connect(this, &QQuickWebEngineProfile::downloadFinished, this, &WaveWebProfile::handleDownloadFinished);
    connect(this, &QQuickWebEngineProfile::presentNotification, this, &WaveWebProfile::showNotification);
}

void WaveWebProfile::handleDownload(QQuickWebEngineDownloadRequest *downloadItem)
{
...
void WaveWebProfile::handleDownloadFinished(DownloadItem *downloadItem)
{
...
void WaveWebProfile::showNotification(QWebEngineNotification *webNotification)
{
    auto *notification = new KNotification(QStringLiteral("web-notification"));
    notification->setComponentName(QStringLiteral("wave"));
...
QWebEngineUrlRequestInterceptor *WaveWebProfile::urlInterceptor() const
{
    return m_urlInterceptor;
}

void WaveWebProfile::setUrlInterceptor(QWebEngineUrlRequestInterceptor *urlRequestInterceptor)
{
