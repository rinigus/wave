    ...
    Item {
        ...
        RowLayout {
            ...
            Controls.ToolButton {
                ...
                visible: webBrowser.landscape || Core.WaveSettings.navBarMainMenu
            ...
            Controls.ToolButton {
                id: tabButton
                visible: webBrowser.landscape || Core.WaveSettings.navBarTabs
                opacity: navigation.dismissOpacity
                Layout.preferredWidth: navigation.buttonSize
                Layout.preferredHeight: navigation.buttonSize
            ...
            Controls.ToolButton {
                ...
                visible: currentWebView.canGoBack && Core.WaveSettings.navBarBack
                opacity: navigation.dismissOpacity
            ...
            Controls.ToolButton {
                ...
                visible: currentWebView.canGoForward && Core.WaveSettings.navBarForward
                opacity: navigation.dismissOpacity
                icon.name: "go-next"
            ...
            Controls.ToolButton {
                ...
                visible: Core.WaveSettings.navBarReload
                opacity: navigation.dismissOpacity
            ...
            Controls.ToolButton {
                ...
                visible: webBrowser.landscape || Core.WaveSettings.navBarContextMenu
                opacity: navigation.dismissOpacity
