...
WebEngineView {
    ...
    settings {
        // autoLoadImages: Core.WaveSettings.webAutoLoadImages
        // javascriptEnabled: Core.WaveSettings.webJavaScriptEnabled
    ...
    onPrintRequested: {
        ...
        const component = Qt.createComponent("org.kde.wave.core", "PrintPreview");
    ...
    QQC2.Menu {
        ...
        QQC2.MenuItem {
            ...
            onTriggered: {
                if (webEngineView.isAppView) {
                    Qt.openUrlExternally(UrlUtils.urlFromUserInput(Core.WaveSettings.searchBaseUrl + fullText));
                } else {
                    tabsModel.newTab(UrlUtils.urlFromUserInput(Core.WaveSettings.searchBaseUrl + fullText));
                }
            }
        }
